...
main(int argc, char *argv[])
{
  ...
  16:	88e50513          	addi	a0,a0,-1906 # 8a0 <malloc+0x106>
  1a:	6cc000ef          	jal	6e6 <printf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  3c:	88858593          	addi	a1,a1,-1912 # 8c0 <malloc+0x126>
  40:	6525                	lui	a0,0x9
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ae:	54650513          	addi	a0,a0,1350 # 8f0 <digits>
 3b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 644:	2b0b8b93          	addi	s7,s7,688 # 8f0 <digits>
 ...
 692:	25a90913          	addi	s2,s2,602 # 8e8 <malloc+0x14e>
        for(; *s; s++)
